...
namespace OutlookAI.Tests.TaskPane.Chat
{
    public class WebView2BootstrapTests
    {
        ...
        public void PrintTemplate_ReferencesStylesMarkdownAndRendererTokens()
        {
            ...
            Assert.Contains("Создано в OutlookAI &middot; __GENERATED_AT__", templateHtml);
        ...
        public void WebUi_ChatRendersFileSavedToolResultsAsFileCard()
        {
            ...
            Assert.Contains("Неизвестная ошибка экспорта.", chatJs);
        ...
        public void WebUi_ChatRendersExportErrorsAsActionableInlineCard()
        {
            ...
            Assert.Contains("'Не удалось экспортировать'", chatJs);
            ...
            Assert.Contains("Установить WebView2 Runtime", chatJs);
            Assert.Contains("install.rel = 'noopener noreferrer';", chatJs);
        ...
        public void WebUi_ChatRoutesPdfExportToolErrorsToInlineErrorCards()
        {
            ...
            Assert.Contains("row.textContent = '\\u26A0 ' + (summary || 'ошибка инструмента');", chatJs);
        }
